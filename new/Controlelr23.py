...
class Controller23(KesslerController):
    """
    ...
    def actions(self, ownship: Dict, input_data: Dict[str, Tuple]) -> Tuple[float, float, bool]:
        ...
        # ニューロの入力はavidance, angdiff
        data = f"{avoidance},{angdiff},{thrust},{turn_rate}\n"
        with open("inout_list.csv", "a") as file:
            file.write(data)
        drop_mine = False
